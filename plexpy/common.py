...
NOTIFICATION_PARAMETERS = [
     ...
     },
    {
        ...
        'parameters': [
             ...
             {'name': 'IMDB URL', 'type': 'str', 'value': 'imdb_url', 'description': 'The IMDB URL for the movie.', 'help_text': 'PMS agent must be Plex Movie'},
             ...
             {'name': 'TVDB URL', 'type': 'str', 'value': 'thetvdb_url', 'description': 'The TVDB URL for the TV show.', 'help_text': 'PMS agent must be TheTVDB'},
             ...
             {'name': 'TMDB URL', 'type': 'str', 'value': 'themoviedb_url', 'description': 'The TMDb URL for the movie or TV show.', 'help_text': 'PMS agent must be The Movie Database'},
             {'name': 'TVmaze ID', 'type': 'int', 'value': 'tvmaze_id', 'description': 'The TVmaze ID for the TV show.', 'example': 'e.g. 290', 'help_text': 'PMS agent must be TheTVDB'},
             {'name': 'TVmaze URL', 'type': 'str', 'value': 'tvmaze_url', 'description': 'The TVmaze URL for the TV show.', 'help_text': 'PMS agent must be TheTVDB'},
             {'name': 'Last.fm URL', 'type': 'str', 'value': 'lastfm_url', 'description': 'The Last.fm URL for the album.', 'help_text': 'PMS agent must be Last.fm'},
